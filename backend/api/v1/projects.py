    ...
    try:
        ...
        if not video_path.exists():
            ...
            if hasattr(project, 'project_metadata') and project.project_metadata:
                source_url = project.project_metadata.get('source_url') or project.source_url
                category = project.project_metadata.get('category', 'general')
            else:
            ...
            if source_url:
                    ...
                    if 'bilibili.com' in source_url:
                        ...
                        or 'facebook.com' in source_url
                        or 'fb.watch' in source_url
                    ):
                        # YouTube/Facebook视频重新下载
                        from .youtube import (
                        ...
                        return {
                            "message": "Video faltante: se inicio la re-descarga del enlace (YouTube/Facebook)",
                            "project_id": project_id,
                            "download_task_id": download_task_id,
                            "source_url": source_url
                        }
