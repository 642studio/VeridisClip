...
class DashScopeProvider(LLMProvider):
    ...
    def call(self, prompt: str, input_data: Any = None, **kwargs) -> LLMResponse:
        ...
        try:
            ...
            if response and response.status_code == 200:
                content = None
                if response.output and getattr(response.output, "text", None) is not None:
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            # Si la llamada no lanza excepción y devuelve contenido, la conexión funciona.
    ...
    def get_available_models(self) -> List[ModelInfo]:
        ...
        return [
            ModelInfo(
                ...
                max_tokens=8192,
                description="Modelo Qwen Plus de Alibaba Cloud"
            ),
            ModelInfo(
                name="qwen-max",
    ...
    def get_available_models(self) -> List[ModelInfo]:
        ...
        return [
            ModelInfo(
                ...
                max_tokens=4096,
                description="Modelo OpenAI GPT-3.5 Turbo"
            ),
            ModelInfo(
                name="gpt-4",
                display_name="GPT-4",
                provider=ProviderType.OPENAI,
                max_tokens=8192,
                description="Modelo OpenAI GPT-4"
            ),
            ModelInfo(
                name="gpt-4-turbo",
                ...
                provider=ProviderType.OPENAI,
                max_tokens=128000,
                description="Modelo OpenAI GPT-4 Turbo"
            )
        ]
    ...
    def get_available_models(self) -> List[ModelInfo]:
        ...
        return [
            ModelInfo(
                ...
                max_tokens=1000000,
                description="Modelo Google Gemini 2.5 Flash"
            ),
            ModelInfo(
                name="gemini-1.5-pro",
                ...
                provider=ProviderType.GEMINI,
                max_tokens=2000000,
                description="Modelo Google Gemini 1.5 Pro"
            ),
            ModelInfo(
                ...
                provider=ProviderType.GEMINI,
                max_tokens=1000000,
                description="Modelo Google Gemini 1.5 Flash"
            )
        ]
    ...
    def get_available_models(self) -> List[ModelInfo]:
        ...
        return [
            ModelInfo(
                ...
                max_tokens=32768,
                description="Modelo SiliconFlow Qwen2.5-7B"
            ),
            ModelInfo(
                ...
                provider=ProviderType.SILICONFLOW,
                max_tokens=32768,
                description="Modelo SiliconFlow Qwen2.5-14B"
            ),
            ModelInfo(
                ...
                provider=ProviderType.SILICONFLOW,
                max_tokens=32768,
                description="Modelo SiliconFlow Qwen2.5-32B"
            ),
            ModelInfo(
                ...
                provider=ProviderType.SILICONFLOW,
                max_tokens=65536,
                description="Modelo SiliconFlow DeepSeek-V2.5"
            )
        ]
