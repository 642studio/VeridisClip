...
const AddClipToCollectionModal: React.FC<AddClipToCollectionModalProps> = ({
  ...
  return (
    <Modal
      title="Agregar clips a la coleccion"
      open={visible}
      ...
      footer={[
        ...
        >
          Agregar {selectedClipIds.length > 0 && `(${selectedClipIds.length})`}
        </Button>
      ]}
    >
      <div className="add-clip-modal-content">
        ...
        <div className="search-section">
          <Search
            placeholder="Buscar por titulo, contenido o motivo recomendado..."
          ...
          <div className="action-bar">
            <Space>
              ...
              {filteredClips.length > 0 && (
                ...
                >
                  {selectedClipIds.length === filteredClips.length ? 'Quitar seleccion' : 'Seleccionar todo'}
                </Button>
              )}
            </Space>
          </div>
              ...
              <Empty
                ...
                description={
                  availableClips.length === 0 
                    ? "Todos los clips ya estan dentro de esta coleccion" 
                    : "No se encontraron clips coincidentes"
                }
              />
            </div>
          )}
