    ...
    <Card
      ...
      cover={
        ...
        >
          ...
          >
            {collection.collection_type === 'ai_recommended' ? 'Recomendado por IA' : 'Creado manualmente'}
          </div>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <Tooltip 
              title={collection.collection_summary || 'Sin descripcion'} 
              placement="top" 
            ...
            >
              ...
              >
                {collection.collection_summary || 'Sin descripcion'}
              </div>
            </Tooltip>
          </div>
        </div>
