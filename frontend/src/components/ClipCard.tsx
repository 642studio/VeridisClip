...
const ClipCard: React.FC<ClipCardProps> = ({ 
  ...
  const getDisplayContent = () => {
    ...
    return 'Sin puntos clave disponibles'
  }
  ...
  return (
    <>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <EditableTitle
                  title={clip.title || clip.generated_title || 'Clip sin titulo'}
                  clipId={clip.id}
      ...
      <Modal
        ...
        title={
          <div style={{ 
            ...
            <EditableTitle
              title={clip.title || clip.generated_title || 'Vista previa del video'}
              clipId={clip.id}
      ...
      <BilibiliManager
        ...
        projectId={projectId || ''}
        clipIds={[clip.id]}
        clipTitles={[clip.title || clip.generated_title || 'Clip de video']}
        onUploadSuccess={() => {
          // 投稿成功后可以刷新数据或显示提示
          console.log('投稿成功')
        }}
