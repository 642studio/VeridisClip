...
const CollectionPreviewModal: React.FC<CollectionPreviewModalProps> = ({
  ...
  const handleDragEnd = async (result: DropResult) => {
    ...
    // 显示加载状态
    const hideLoading = message.loading('Actualizando orden de clips...', 0)
    setIsUpdating(true)
    ...
    try {
      ...
      hideLoading()
      message.error('No se pudo actualizar el orden de clips')
    } finally {
      setIsUpdating(false)
    }
  }
  ...
  const handleRemoveClip = async (clipId: string) => {
    ...
    const hideLoading = message.loading('Quitando clip...', 0)
    setIsUpdating(true)
    ...
    try {
      ...
      hideLoading()
      message.error('No se pudo quitar el clip')
    } finally {
      setIsUpdating(false)
    }
  }
  ...
  const handleAddClips = async (selectedClipIds: string[]) => {
    ...
    const hideLoading = message.loading('Agregando clips...', 0)
    setIsUpdating(true)
    ...
    try {
      ...
      hideLoading()
      message.error('No se pudieron agregar los clips')
    } finally {
      setIsUpdating(false)
    }
  }
  ...
  return (
    ...
    >
        ...
        <div className="preview-header">
          ...
          <div className="header-right">
            <Space>
              ...
              >
                Publicar en Bilibili
              </Button>
              {onDelete && (
                <Popconfirm
                  title="Eliminar coleccion"
                  description="¿Seguro que quieres eliminar esta coleccion? Esta accion no se puede deshacer."
                ...
                <div className="video-container">
                  {currentClip ? (
                    ...
                    <div className="empty-video">
                      ...
                      <Text style={{ color: '#999', marginTop: 16 }}>Sin contenido de video</Text>
                    </div>
                  )}
                </div>
                    ...
                    <div className="video-info-content">
                      <div className="video-title-section">
                        <div className="video-title">
                          <EditableTitle
                            title={currentClip.title || currentClip.generated_title || 'Clip sin titulo'}
                        ...
                        <div className="video-meta">
                          ...
                          >
                            Puntuacion: {(currentClip.final_score * 100).toFixed(0)}
                          </Tag>
            ...
            <Col span={8} className="playlist-section">
              <div className="playlist-container">
                <div className="playlist-header">
                  <div>
                    <Title level={5} style={{ margin: 0 }}>Lista de reproduccion</Title>
                    <Text type="secondary">Arrastra para reordenar</Text>
                  </div>
                  {onAddClip && (
                    <Button 
                      type="primary" 
                            ...
                            {(provided, snapshot) => (
                              ...
                              >
                                  ...
                                  <div className="clip-meta">
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '12px' }}>
                                      ...
                                      <span style={{
                                        ...
                                        Puntuacion: {(clip.final_score * 100).toFixed(0)}
                                      </span>
                                    </div>
                                  </div>
                                ...
                                <div className="clip-actions">
                                  <Popconfirm
                                    title="¿Quitar este clip de la coleccion?"
                                    onConfirm={(e) => {
                                      e?.stopPropagation()
      ...
      <UploadModal
        ...
        clipTitles={collectionClips.map(clip => clip.generated_title || clip.title || 'Clip de video')}
        onSuccess={() => {
          // 投稿成功后可以刷新数据或显示提示
          console.log('合集投稿成功')
        }}
