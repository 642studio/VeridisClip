      ...
      <div className="modal-content">
        ...
        <div className="modal-header">
          ...
          <div className="header-text">
            <Title level={3} className="modal-title">Crear nueva coleccion</Title>
            <Text className="modal-subtitle">Combina clips seleccionados en una coleccion tematica</Text>
          </div>
        </div>
        ...
        <div className="form-section">
          {/* Titulo de la coleccion */}
          <div className="form-item">
            <div className="form-label">
              <TagOutlined className="label-icon" />
              <Text strong>Titulo de la coleccion</Text>
              <span className="required-mark">*</span>
            </div>
            <Input
              placeholder="Escribe el titulo de la coleccion"
              value={title}
          ...
          <div className="form-item">
            <div className="form-label">
              ...
              <Text strong>Seleccionar clips</Text>
              <span className="required-mark">*</span>
            </div>
            ...
            <div className="clips-selection">
              <div className="selection-header">
                <Text className="selection-info">
                  Seleccionados: {selectedClips.length} clips
                </Text>
                  ...
                  >
                    ...
                    <div className="clip-content">
                      <div className="clip-title">
                        {clip.generated_title || clip.title || 'Clip sin titulo'}
                      </div>
                      <div className="clip-meta">
                        <Text type="secondary" style={{ fontSize: '12px' }}>
                          {clip.start_time} - {clip.end_time} • Puntuacion: {(clip.final_score * 100).toFixed(0)}
                        </Text>
                      </div>
                    </div>
                  </div>
