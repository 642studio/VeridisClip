...
const ProjectDetailPage: React.FC = () => {
  ...
  //     console.log('ProjectDetailPage同步订阅Canal:', desiredChannels)
  ...
  const loadProject = async () => {
    ...
    try {
      ...
      // 如果项目Completado，加载clips和collections
      if (project.status === 'completed') {
        try {
          ...
          // 即使clips/collectionsError de carga，也设置项目基本信息
  ...
  const getSortedClips = () => {
    ...
    if (sortBy === 'score') {
      ...
      // 按时间Ordenar - 将时间caracteres串转换为秒数进行比较
